...
public class ChatServerDemo implements Runnable {
                        ...
                        if(key.isValid() && key.isReadable()){
                           ...
                           // readMsg(key);
                            ...
                            if(size > 0){
                                ...
                                buffer.flip();
                                buf.append(new String(buffer.array(), 0, size));
                            }
                            String msg = buf.toString();
                            System.out.println("msg:"+msg);
                            channel.write(ByteBuffer.wrap("respose".getBytes()));
                            channel.close();
                        }
                        //若此key的通道是写数据状态
    ...
    public static void main(String[] args) {
        ChatServerDemo server = new ChatServerDemo();
